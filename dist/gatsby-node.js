...
function () {
  ...
  _regenerator.default.mark(function _callee(_ref3, pluginOptions) {
    var page, actions, createPage, deletePage, _pluginOptions$path, path, _pluginOptions$langua, languages, _pluginOptions$defaul, defaultLanguage, _pluginOptions$redire2, redirect, _pluginOptions$ignore, ignoreRedirectUrls, getMessages, generatePage, newPage;
